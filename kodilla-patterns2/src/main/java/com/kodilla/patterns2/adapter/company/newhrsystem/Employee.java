...
public class Employee {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Employee)) return false; //jezeli obiekt któy przychodzi jest inny  porónuje z obiektem Employye
    ...
    } //jezli pesel rózny od nulla oblicz hascode z peselu a jesli nie zwroc 0
