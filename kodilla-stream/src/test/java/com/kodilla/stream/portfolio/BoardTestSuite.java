...
class BoardTestSuite {
    ...
    void gitestAddTaskListAverageWorkingOnTask(){
        ...
        //when
        List<TaskList>averageWorkingOnTaskList = new ArrayList<>();
        averageWorkingOnTaskList.add(new TaskList("In progress"));
        double getAver = average.getTaskLists().stream()
                .filter(taskList -> averageWorkingOnTaskList.contains(taskList)) // ta linjka sprawdza czy zadanie z In progres znajduję w lisce
